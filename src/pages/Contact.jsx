...
export default function Contact() {
  ...
  return (
    <div style={{overflowX:"hidden"}} className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div
...
/>
      ...
      <div className="mx-auto max-w-4xl text-center">
        <h2 style={{marginTop:'-5vh'}} className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Get in Touch with Us</h2>
        <p style={{marginBottom:"-10vh"}}className="mt-2 text-lg leading-8 text-gray-600">
